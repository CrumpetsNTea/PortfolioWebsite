              ...
              <Grid item xs={2} sm={4} md={4}>
                <Card
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography>
                      An NFT collection and DApp built on the Ethereum
                      Blockchain. Connect with a MetaMask wallet that is
                      connected to the Rinkeby Testnet and mint a lurry!
                    </Typography>
                  </CardContent>
                  <CardActions>
                    <Button
              ...
              <Grid item xs={2} sm={4} md={4}>
                <Card
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography>
                      Scheduler is a single page application built using the
                      React framework where user's are able to book a
                      appointments, selecting who they would like their
                      appointment to be with, what time, and what day.
                    </Typography>
                  </CardContent>
                  <CardActions>
                    <Button
